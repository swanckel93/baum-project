...
def read_projects(
    ...
    if user_id:
        ...
        projects = project_service.get_by_client(db, client_id=client_id, skip=skip, limit=limit)
    elif status_filter:
        projects = project_service.get_by_status(db, status=status_filter, skip=skip, limit=limit)
    elif active_only:
