...
class TestProjectEndpoints:
    ...
    def test_create_project_success(
        self, client, sample_user_data, sample_client_data, sample_project_data
    ):
        """Test successful project creation"""
        user_id, client_id = self.setup_dependencies(
            client, sample_user_data, sample_client_data
        )
    ...
    def test_create_project_name_validation(
        self, client, sample_user_data, sample_client_data, sample_project_data
    ):
    ...
    def test_create_project_name_trimming(
        self, client, sample_user_data, sample_client_data, sample_project_data
    ):
    ...
    def test_create_project_budget_validation(
        self, client, sample_user_data, sample_client_data, sample_project_data
    ):
    ...
    def test_create_project_budget_zero_validation(
        self, client, sample_user_data, sample_client_data, sample_project_data
    ):
    ...
    def test_create_project_end_before_start_validation(
        self, client, sample_user_data, sample_client_data, sample_project_data
    ):
    ...
    def test_create_project_invalid_client_id(
        self, client, sample_user_data, sample_client_data, sample_project_data
    ):
    ...
    def test_list_projects_with_filters(
        ...
        test_cases = [
            {"params": "", "expected_count": 1},
            {
                ...
                "expected_count": 1,
            },  # Project is in planning status (considered active)
