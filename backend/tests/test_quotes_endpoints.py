...
class TestQuoteEndpoints:
    ...
    def setup_dependencies(
        ...
        # Create craftsman
        craftsman_response = client.post(
            "/api/v1/craftsmen/", json=sample_craftsman_data
        )
    ...
    def test_create_quote_success(
        ...
        user_id, client_id, craftsman_id, project_id, campaign_id, item_id = (
    ...
    def test_create_quote_price_validation(
        self,
        client,
        sample_user_data,
        sample_client_data,
    ...
    def test_create_quote_valid_until_validation(
        self,
        client,
        sample_user_data,
        sample_client_data,
    ...
    def test_create_quote_valid_until_success(
        self,
        client,
        sample_user_data,
        sample_client_data,
    ...
    def test_create_quote_whatsapp_message_validation(
        self,
        client,
        sample_user_data,
        sample_client_data,
    ...
    def test_create_quote_whatsapp_message_trimming(
        self,
        client,
        sample_user_data,
        sample_client_data,
    ...
    def test_create_quote_margin_validation(
        self,
        client,
        sample_user_data,
        sample_client_data,
    ...
    def test_update_quote_validation(
        self,
        client,
        sample_user_data,
        sample_client_data,
    ...
    def test_list_quotes_with_filters(
        self,
        client,
        sample_user_data,
        sample_client_data,
    ...
    def test_quote_response_schema(
        self,
        client,
        sample_user_data,
        sample_client_data,
