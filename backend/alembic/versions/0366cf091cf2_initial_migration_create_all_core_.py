...
def upgrade() -> None:
    ...
    sa.Column('name', sa.String(length=255), nullable=False),
    sa.Column('description', sa.Text(), nullable=True),
    sa.Column('status', sa.Enum('ACTIVE', 'COMPLETED', 'CANCELLED', 'ON_HOLD', name='campaignstatus'), nullable=False),
    ...
    sa.Column('unit', sa.Enum('UNIT', 'HOUR', 'SQUARE_METER', 'LINEAR_METER', 'KILOGRAM', 'CUBIC_METER', name='unit'), nullable=False),
    ...
    sa.Column('description', sa.Text(), nullable=True),
    sa.Column('status', sa.Enum('PENDING', 'APPROVED', 'REJECTED', 'EXPIRED', name='quotestatus'), nullable=False),
